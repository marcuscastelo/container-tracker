...
import { createInstalledLinuxControlService } from '@tools/agent/electron/main/installed-linux-control-service'
import {
...
function createMainWindow(): ElectronBrowserWindow {
  ...
  const createdWindow = new BrowserWindow({
    ...
    webPreferences: {
      preload: path.resolve(currentDir, '../../../agent-control-ui/preload.cjs'),
      sandbox: false,
