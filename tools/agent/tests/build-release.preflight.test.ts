...
import { collectInstallerTaskRegistrationErrors } from '@tools/agent/build-release'
...
Filename: "schtasks.exe"; Parameters: "/Create /SC ONLOGON /IT /RL LIMITED /TN ""ContainerTrackerAgent"" /TR ""powershell.exe -NoProfile -ExecutionPolicy Bypass -WindowStyle Hidden -File """"{app}\\app\\dist\\agent-tray-host.ps1"""""""
