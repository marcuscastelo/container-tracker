...
import { ensureDirectory, runCommand, tryCommand } from './common.js';
import { createWindowsLocalControlAdapter } from './local-control.adapter.js';
...
function extractZipOnWindows(archivePath, destinationDir) {
...
export const windowsPlatformAdapter = {
    key: 'windows-x64',
