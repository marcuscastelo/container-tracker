...
import { AgentControlBackendUrlInputSchema, AgentControlBlockedVersionsInputSchema, AgentControlChannelInputSchema, AgentControlConfigPatchInputSchema, AgentControlLogsQuerySchema, AgentControlReleaseVersionInputSchema, agentControlIpcChannels, } from '@agent/electron/ipc';
import { createInstalledLinuxControlService } from '@agent/electron/main/installed-linux-control-service';
import { createWindowLifecycleController, setupSingleInstance, } from '@agent/electron/main/window-controller';
