...
function tryExtractRawText(payload) {
...
function tryExtractRejectedSupportId(rawText) {
...
function isPilNoncePayload(value) {
...
async function fetchPilNonce(timestampMs, containerNumber) {
    const response = await axios.get(`https://www.pilship.com/wp-content/themes/hello-theme-child-master/pil-api/common/get-n.php?timestamp=${timestampMs}`, {
        responseType: 'text',
        decompress: true,
        timeout: 30_000,
        validateStatus: () => true,
...
function toPilParseError(payload) {
...
export async function fetchPilStatus(containerNumber) {
    ...
    const response = await axios.get(`https://www.pilship.com/wp-content/themes/hello-theme-child-master/pil-api/trackntrace-containertnt.php?${params.toString()}`, {
        responseType: 'text',
        decompress: true,
        timeout: 30_000,
        validateStatus: () => true,
