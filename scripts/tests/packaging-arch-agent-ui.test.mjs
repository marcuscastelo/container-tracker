...
describe('Arch packaging for agent UI and tray', () => {
  it('declares the Linux tray/UI assets in PKGBUILD', () => {
    ...
    expect(pkgbuild).toContain('dist/agent-control-ui')
  ...
  it('installs desktop launchers and tray autostart descriptors', () => {
    ...
    expect(uiLauncher).toContain('app_dir="$install_root/dist/agent-control-ui"')
    expect(trayLauncher).toContain('app_dir="$install_root/dist/agent-control-ui"')
