...
|---|---|---|---|---|---|---|
| `src/capabilities/dashboard/application/dashboard.navbar-alerts.readmodel.ts` | Capability dashboard maintainers | refactor-local | Extracted message-contract, grouping/sorting, and shared model helpers; keep read model as composition entrypoint | resolved | P0 | Next baseline |
