...
- `sync_requests` is the operational queue and realtime backbone. It stores `PENDING | LEASED | DONE | FAILED`, leasing metadata, attempts, and last error (`supabase/migrations/20260225_01_agent_sync_mvp.sql:14-40`).
