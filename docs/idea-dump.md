...
Se em ShipmentView o processo estiver usando id uuid por falta de ref, exibir um pequeno "i-zinho" com tooltip explicando que o id é interno e um cta para editar o processo e adicionar uma referencia customizada (melhora a experiencia do usuario, evita confusao)
