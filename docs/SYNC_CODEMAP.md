...
This file lists main source files involved in sync, grouped by responsibility.
...
|`src/shared/api/sync-requests.realtime.client.ts`|frontend wrapper around shared realtime helper (`src/shared/api/sync-requests.realtime.client.ts:1-35`)|
