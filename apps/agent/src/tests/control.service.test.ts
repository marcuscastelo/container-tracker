import { createControlCommand } from '@agent/control/control.commands'
  ...
  it('dispatches lifecycle commands through the canonical control contract', async () => {
    ...
    const service = createControlService({
      layout: {
        ...
        bootstrapEnvPath: '/tmp/agent/bootstrap.env',
        consumedBootstrapEnvPath: '/tmp/agent/bootstrap.env.consumed',
        installerTokenStatePath: '/tmp/agent/installer-token-state.json',
        releasesDir: '/tmp/agent/releases',
        downloadsDir: '/tmp/agent/downloads',
        logsDir: '/tmp/agent/logs',
        currentPath: '/tmp/agent/current',
        previousPath: '/tmp/agent/previous',
        releaseStatePath: '/tmp/agent/release-state.json',
        runtimeStatePath: '/tmp/agent/runtime-state.json',
        supervisorControlPath: '/tmp/agent/supervisor-control.json',
