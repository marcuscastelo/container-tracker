...
// biome-ignore lint/style/noRestrictedImports: Build script must keep relative imports for dist runtime execution.
...
async function pruneRuntimeNodeModules(
  ...
  const symlinkType: fsSync.symlink.Type = resolveDirectorySymlinkType()
