...
const EXPORT_IMPORT_CAPABILITY_ROOT = path.resolve(process.cwd(), 'src/capabilities/export-import')
...
describe('export-import capability boundary guard', () => {
  it('forbids imports from modules/*/domain within src/capabilities/export-import/**', async () => {
    const sourceFiles = await listSourceFiles(EXPORT_IMPORT_CAPABILITY_ROOT)
