...
Global operational search for Container Tracker platform.
...
1. **Read-model approach**: Search queries Supabase directly via
...
3. **Consolidated process rows**: Results are rendered one row per process,
...
share same `SearchOverlay` component.
