  ...
  return (
    <section id="shipment-alerts" class="space-y-2 scroll-mt-[120px]">
      <Show when={props.activeAlerts.length > 0}>
        <div class="rounded-lg border border-[var(--status-warning-border)] bg-[var(--status-warning-bg)] p-2 shadow-[var(--card-shadow)]">
          <div class="flex items-center gap-2 mb-1.5">
            <svg
              class="h-4 w-4 text-[var(--status-warning-icon)]"
              viewBox="0 0 24 24"
              fill="none"
              stroke="currentColor"
              aria-hidden="true"
            ...
            <span class="text-sm-ui font-semibold text-[var(--status-warning-text)]">
      ...
      <Show when={props.archivedAlerts.length > 0}>
        <details class="rounded-lg border border-[var(--border-default)] bg-[var(--bg-surface-subtle)] p-2">
          <summary class="cursor-pointer select-none text-micro font-medium uppercase tracking-wider text-[var(--text-tertiary)]">
      ...
      <Show when={!hasAnyAlert()}>
        <div class="rounded-lg border border-[var(--border-default)] bg-[var(--bg-surface)] px-3 py-2.5 text-sm-ui text-[var(--text-tertiary)]">
