...
import delivered from '~/modules/tracking/infrastructure/tests/fixtures/msc/msc_delivered.json'
import dischargePod from '~/modules/tracking/infrastructure/tests/fixtures/msc/msc_discharge_pod.json'
import initialLoad from '~/modules/tracking/infrastructure/tests/fixtures/msc/msc_initial_load.json'
import transshipment from '~/modules/tracking/infrastructure/tests/fixtures/msc/msc_transshipment.json'
