...
const OBSERVATION_DOMAIN_SELECT =
  'id,fingerprint,container_id,container_number,type,temporal_kind,event_time_instant,event_date,event_time_local,event_time_zone,event_time_type,location_code,location_display,vessel_name,voyage,is_empty,confidence,provider,created_from_snapshot_id,carrier_label,raw_event_time,event_time_source,created_at,retroactive'
