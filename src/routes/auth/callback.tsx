...
import { resolveReturnToFromCallbackSearch } from '~/shared/auth/auth-return-to'
import { getWorkosAccessToken } from '~/shared/auth/workos-auth.client'
import { useTranslation } from '~/shared/localization/i18n'

export function resolveAuthCallbackReturnTo(search: string): string {
  return resolveReturnToFromCallbackSearch(search)
}
...
export default function AuthCallbackRoute() {
  ...
  onMount(() => {
    const returnTo = resolveAuthCallbackReturnTo(location.search)
