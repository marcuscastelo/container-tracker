/**
 * Tracking replay API route — thin adapter to the tracking replay controller.
 *
 * GET /api/tracking/replay/:containerId
 */
...
export const GET = replayController.getReplay
