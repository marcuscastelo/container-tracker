...
function HeaderSearch(props: { readonly searchSlot?: JSX.Element }): JSX.Element {
  return (
    <Show when={props.searchSlot}>
      {(searchSlot) => (
        <div class="mx-auto w-full min-w-[220px] max-w-[var(--dashboard-search-width)] [&_[data-slot='input']]:h-[var(--dashboard-search-height)] [&_[data-slot='input']]:min-h-[var(--dashboard-search-height)] [&_[data-search-trigger='true']]:h-[var(--dashboard-search-height)] [&_[data-search-trigger='true']]:min-h-[var(--dashboard-search-height)]">
          {searchSlot()}
        </div>
      )}
    </Show>
